...
public class NÛPrincipal {
    ...
    //funcıes
    NÛPrincipal proximoValor;
    NÛPrincipal anteriorValor;
    ...
    public NÛPrincipal getProximoValor() {
        return proximoValor;
    }

    public void setProximoValor(NÛPrincipal proximoDado) {
        this.proximoValor = proximoDado;
    }

    public NÛPrincipal getDadoAnterior() {
        return anteriorValor;
    }
    public void setAnteriorValor(NÛPrincipal dadoAnterior) {
        this.anteriorValor = dadoAnterior;
    }
    
    public NÛPrincipal(int trip_id, int duration, String start_time, String end_time, String bike_id, String trip_route_category,
