    ...
    public void OrdenaStartStation(){
        ...
        try {
            ...
            while((line = br.readLine()) != null){
                ...
                this.InicialStationLista.inserirStart_station(new NÛPrincipal(Integer.parseInt(linha[0]), Integer.parseInt(linha[1]), linha[2], linha[3], linha[4], linha[5], Integer.parseInt(linha[6]), linha[7], linha[8], linha[9], linha[10], linha[11], linha[12], linha[13], linha[14], linha[15]));
